...
<body class="font-sans text-gray-900 antialiased bg-[#F5F0E1]">
    <div class="min-h-screen flex">
        ...
        {{-- Kanan: Form Login --}}
        <div class="w-full lg:w-1/2 bg-white rounded-none lg:rounded-l-[3rem] shadow-2xl flex flex-col justify-center items-center p-8 sm:p-12">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3 relative">
                        ...
                        <div class="absolute inset-y-0 right-0 flex items-center pr-2 cursor-pointer" onclick="togglePassword()">
                            ...
                            <svg id="eye-off-icon" class="w-5 h-5 text-gray-400 hover:text-gray-600 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M3 3l18 18"></path>
                            </svg>
                        </div>
                    ...
                    <div class="flex justify-end mb-8">
                        @if (Route::has('password.request'))
                            <a class="text-sm text-[#D4813B] hover:text-orange-700 hover:underline transition-colors" href="{{ route('password.request') }}">
                                Lupa Password ?
                            </a>
                        @endif
                    </div>
                    ...
                    {{-- Tombol Login --}}
                    <button type="submit" class="w-full flex justify-center py-3 px-4 rounded-lg shadow-md text-base font-bold text-white bg-[#D4813B] hover:bg-[#b86d30] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#D4813B] transition duration-200 ease-in-out">
                        Login
                    </button>
