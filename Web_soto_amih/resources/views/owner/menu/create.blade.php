                        ...
                        <div id="drop-area" onclick="document.getElementById('foto').click()"
                            ...
                            <div id="placeholder" class="flex flex-col items-center gap-2 text-gray-400">
                                <div class="w-16 h-16 rounded-full flex items-center justify-center"
                                    ...
                                    <svg class="w-8 h-8" style="color: #C97B2E;" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div id="overlay"
                                class="hidden absolute inset-0 bg-black bg-opacity-40 rounded-2xl items-center justify-center">
                                ...
                                @foreach (['Makanan', 'Minuman', 'Lainnya'] as $kat)
                                    <label class="flex-1 cursor-pointer">
                                        <input type="radio" name="kategori" value="{{ $kat }}"
                                            class="hidden peer" {{ old('kategori') == $kat ? 'checked' : '' }}>
                                        <div
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    Dihitung otomatis dari bahan jadi
                                </div>
                            </div>
                        </div>
                    </div>
